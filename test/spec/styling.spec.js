        ...
        <section class="bio-properties-panel-styles-section">
          ...
          <div class="bio-properties-panel-entry has-error">
            ...
            <div class="bio-properties-panel-error">
              <span class="bio-properties-panel-error-message bio-properties-panel-diagnostic-message">Value must be a valid ISO 8601 duration.</span>
              <button type="button" class="bio-properties-panel-error-action bio-properties-panel-diagnostic-action">Fix</button>
            </div>
          </div>
          <div class="bio-properties-panel-entry has-warning">
            ...
            <div class="bio-properties-panel-warning">
              <span class="bio-properties-panel-error-message bio-properties-panel-diagnostic-message">Retry count exceeds recommended maximum of 10.</span>
              <button type="button" class="bio-properties-panel-error-action bio-properties-panel-diagnostic-action">Fix</button>
            </div>
          </div>
          <div class="bio-properties-panel-entry has-error">
            <label class="bio-properties-panel-label">Error with long action label</label>
            <input class="bio-properties-panel-input bio-properties-panel-focus-ring" type="text" value="" />
            <div class="bio-properties-panel-error">
              <span class="bio-properties-panel-error-message bio-properties-panel-diagnostic-message">Value could not be determined automatically.</span>
              <button type="button" class="bio-properties-panel-error-action bio-properties-panel-diagnostic-action">Input from an agent</button>
            </div>
          </div>
        </section>
