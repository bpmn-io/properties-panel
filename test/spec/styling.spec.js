      ...
      <div class="bio-properties-panel-styles">
        ...
        <section class="bio-properties-panel-styles-section">
          ...
          <div class="bio-properties-panel-entry has-error">
            ...
            <div class="bio-properties-panel-error">
              <span class="bio-properties-panel-diagnostic-message">Value could not be determined automatically.</span>
              <button type="button" class="bio-properties-panel-diagnostic-action">Input from an agent</button>
            </div>
          </div>
        </section>
