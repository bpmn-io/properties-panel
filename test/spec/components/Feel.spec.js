...
describe('<FeelEntry>', function() {
  ...
  describe('FEEL disabled (Toggle Switch)', function() {
    ...
    it('should render as FEEL disabled for optional-default-enabled and value = false', async function() {
  ...
  describe('FEEL enabled', function() {
    ...
    it('should commit FEEL editor value when debounce changes without element remount', async function() {
